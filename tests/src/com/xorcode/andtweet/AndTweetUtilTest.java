...
import com.xorcode.andtweet.util.*;

public class AndTweetUtilTest extends ActivityTestCase {
    static final String TAG = AndTweetUtilTest.class.getSimpleName();
    ...
    MessageFormatTest[] messageFormatTests = new MessageFormatTest[]{ 
    	new MessageFormatTest(R.string.appwidget_new_tweet_format,
    			1, R.array.appwidget_tweet_patterns, R.array.appwidget_tweet_formats),	
    	new MessageFormatTest(R.string.appwidget_new_tweet_format,
    			2, R.array.appwidget_tweet_patterns, R.array.appwidget_tweet_formats),	
    	new MessageFormatTest(R.string.appwidget_new_tweet_format,
				3, R.array.appwidget_tweet_patterns, R.array.appwidget_tweet_formats),	
    	new MessageFormatTest(R.string.appwidget_new_tweet_format,
    			4, R.array.appwidget_tweet_patterns, R.array.appwidget_tweet_formats),	
    	new MessageFormatTest(R.string.appwidget_new_tweet_format,
    			5, R.array.appwidget_tweet_patterns, R.array.appwidget_tweet_formats),	
    	new MessageFormatTest(R.string.appwidget_new_tweet_format,
    			11, R.array.appwidget_tweet_patterns, R.array.appwidget_tweet_formats),	
    	new MessageFormatTest(R.string.appwidget_new_tweet_format,
    			12, R.array.appwidget_tweet_patterns, R.array.appwidget_tweet_formats),	
    	new MessageFormatTest(R.string.appwidget_new_tweet_format,
    			21, R.array.appwidget_tweet_patterns, R.array.appwidget_tweet_formats),	
    	new MessageFormatTest(R.string.appwidget_new_tweet_format,
    			52, R.array.appwidget_tweet_patterns, R.array.appwidget_tweet_formats),	
    	new MessageFormatTest(R.string.appwidget_new_tweet_format,
    			111, R.array.appwidget_tweet_patterns, R.array.appwidget_tweet_formats),	
    	new MessageFormatTest(R.string.appwidget_new_tweet_format,
    			114, R.array.appwidget_tweet_patterns, R.array.appwidget_tweet_formats),	
    	new MessageFormatTest(R.string.appwidget_new_tweet_format,
    			123, R.array.appwidget_tweet_patterns, R.array.appwidget_tweet_formats),	
    	new MessageFormatTest(R.string.appwidget_new_tweet_format,
    			211, R.array.appwidget_tweet_patterns, R.array.appwidget_tweet_formats),	
    	new MessageFormatTest(R.string.appwidget_new_tweet_format,
    			2123, R.array.appwidget_tweet_patterns, R.array.appwidget_tweet_formats),	

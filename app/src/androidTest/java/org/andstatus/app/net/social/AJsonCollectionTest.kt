...
class AJsonCollectionTest {
    ...
    fun testDefaultPage() {
        val c1: AJsonCollection = AJsonCollection.Companion.of(RawResourceUtils.getString(R.raw.activitypub_inbox_pleroma_default))
        ...
        val c2: AJsonCollection = AJsonCollection.Companion.of(RawResourceUtils.getString(R.raw.activitypub_inbox_pleroma_first))

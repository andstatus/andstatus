...
internal abstract class MyServiceTest {
    var mService: MyServiceTestHelper? = null

    @Volatile
    protected var ma: MyAccount? = null
    @Before
    ...
    fun setUp() {
        ...
        try {
            ...
            Assert.assertTrue("No successfully verified accounts", ma.isValidAndSucceeded())
            ...
            MyLog.i(this, "setUp ended " +
                    ...
                    " instanceId=" + if (mService == null) "null" else mService.connectionInstanceId)
        }
    }
    ...
    @Throws(Exception::class)
    fun tearDown() {
        MyLog.i(this, "tearDown started" + if (mService == null) ", mService:null" else "")
        if (mService != null) {
            mService.tearDown()
        }

 ...
 */
package org.andstatus.app.activityimport
...
class NotificationsTimelineTest : TimelineActivityTest<ActivityViewItem?>() {
    override fun getActivityIntent(): Intent? {
        ...
        return Intent(Intent.ACTION_VIEW,
                MyContextHolder.Companion.myContextHolder.getNow().timelines().get(TimelineType.NOTIFICATIONS, ma.actor, ma.origin).getUri())
    }

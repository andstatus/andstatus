...
class TimelineActivityTest1 : TimelineActivityTest<ActivityViewItem?>() {
    ...
    override fun getActivityIntent(): Intent? {
        ...
        return Intent(Intent.ACTION_VIEW, MyContextHolder.Companion.myContextHolder.getNow().timelines()
                .get(TimelineType.HOME, ma.getActor(), Origin.Companion.EMPTY).getUri())
    }
    ...
    fun testOpeningConversationActivity() {
        ...
        val noteId = helper.listItemIdOfLoadedReply
    ...
    private fun onePositionOnContentChange(position0: Int, iterationId: Int) {
        ...
        instrumentation.runOnMainSync { activity.showList(WhichPage.TOP) }
        ...
        for (attempt in 0..9) {
            ...
            if (LoadableListPosition.Companion.getViewOfPosition(getListView(), position0) != null) {
                itemIdOfSelected = activity.listAdapter.getItemId(position0)

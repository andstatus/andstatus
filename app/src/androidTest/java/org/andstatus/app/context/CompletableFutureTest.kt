...
class CompletableFutureTest {
    internal class TestData(val stepNumber: Long, val messages: MutableList<String?>?) {
        ...
        companion object {
            val EMPTY: TestData? = TestData(0, emptyList())
        }
    }
    ...
    private fun assertFuture3(message: String?, testData: TestData?) {
        ...
        MatcherAssert.assertThat("future3 messages $testData", testData.messages.get(1), StringStartsWith.startsWith("Step 2"))
        MatcherAssert.assertThat("future3 messages $testData", testData.messages.get(2), StringStartsWith.startsWith("Step 3"))

...
class MyBackupAgentTest {
    ...
    fun setUp() {
        ...
        MyBackupAgentTest.Companion.ensureOneFileExistsInDownloads()
    }
    ...
    private fun testBackup(backupFolder: DocumentFile?): DocumentFile? {
        ...
        val dataFolder = backupManager.getDataFolder()
    ...
    private fun testRestore(dataFolder: DocumentFile?) {
        ...
        Assert.assertTrue("Data folder exists: '" + backupManager.getDataFolder().uri + "'", backupManager.getDataFolder().exists())

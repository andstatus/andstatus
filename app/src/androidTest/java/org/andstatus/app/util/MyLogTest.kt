 ...
 */
package org.andstatus.app.utilimport
...
class MyLogTest {
    ...
    fun testLogFilename() {
        ...
        Assert.assertFalse(StringUtil.isEmpty(MyLog.getLogFilename()))
        MyLog.v(this, method)
        val file = MyLog.getFileInLogDir(MyLog.getLogFilename(), true)
        Assert.assertTrue(file.exists())
        MyLog.setLogToFile(false)
        Assert.assertTrue(StringUtil.isEmpty(MyLog.getLogFilename()))

...
class ActorTest {
    ...
    fun testFromBodyText1() {
        ...
        val body =
            """@${DemoData.demoData.gnusocialTestAccountUsername} @${DemoData.demoData.gnusocialTestAccount2Username} Please take this into account
@$anotherUser2 @${DemoData.demoData.gnusocialTestAccount2Username} And we also send this to the group !$groupname1 And let me mention: @$shortUsername3"""
        val actors: List<Actor> =
            Actor.Companion.newUnknown(origin, GroupType.UNKNOWN).extractActorsFromContent(body, Actor.EMPTY)
        val msgLog = "$body ->\n$actors"
        ...
        assertEquals(msgLog, anotherUser2.lowercase(MyLocale.MY_DEFAULT_LOCALE), actors[2].webFingerId)
    ...
    fun testWebFingerIdCreation() {
        ...
        val author2 =
            DemoNoteInserter(accountActor).buildActorFromOid(DemoData.demoData.conversationAuthorSecondActorOid)

...
class ConnectionTwitterTest {
    ...
    fun testGetTimeline() {
        ...
        Assert.assertEquals("Created at", connection.parseDate("Tue Nov 30 18:17:25 +0000 2010"), author.getCreatedDate())
        ...
        Assert.assertEquals("Reply to the note by actorOid", DemoData.demoData.twitterTestAccountActorOid, note.inReplyTo.getAuthor().oid)

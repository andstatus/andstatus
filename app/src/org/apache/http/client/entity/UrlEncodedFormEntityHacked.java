...
import org.apache.http.client.utils.URLEncodedUtilsHacked;
...
public class UrlEncodedFormEntityHacked extends StringEntityHC4 {
     ...
     */
    public UrlEncodedFormEntityHacked (
        final List <? extends NameValuePair> parameters,
        final String charset) throws UnsupportedEncodingException {
        super(URLEncodedUtilsHacked.format(parameters,
                charset != null ? charset : Charset.forName(HTTP.DEFAULT_CONTENT_CHARSET).name()),
                ContentType.create(URLEncodedUtilsHacked.CONTENT_TYPE, charset));
    }

...
internal class Convert42 : ConvertOneStep() {
    private class Data private constructor(val id: Long, val uri: Uri) {
        companion object {
            fun fromCursor(cursor: Cursor?): Convert42.Data? {
                return Convert42.Data(
    ...
    protected override fun execute2() {
        ...
        MyQuery.foldLeft(db, sql, HashSet(), { set: MutableSet<Convert42.Data?>? ->
            Function { cursor: Cursor? ->
                set.add(Convert42.Data.Companion.fromCursor(cursor))
                set
            }
        }).stream().filter { data: Convert42.Data? -> data.uri !== Uri.EMPTY }.forEach { data: Convert42.Data? ->

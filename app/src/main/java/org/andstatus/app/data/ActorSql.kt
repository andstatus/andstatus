...
object ActorSql {
    ...
    fun baseProjection(): Array<String?>? {
        return (if (MyPreferences.getShowAvatars()) Stream.concat(ActorSql.baseProjectionMap.keys.stream(), ActorSql.avatarProjectionMap.keys.stream()) else ActorSql.baseProjectionMap.keys.stream())
                .collect(Collectors.toSet())
                .toArray<String?>(arrayOf<String?>())
    }

    fun selectFullProjection(): String {
        return ActorSql.select(true, false)
    }

    fun select(fullProjection: Boolean, userOnly: Boolean): String {
        return (if (fullProjection) ActorSql.fullProjectionMap.values.stream() else if (userOnly) ActorSql.userOnlyProjectionMap.values.stream() else if (MyPreferences.getShowAvatars()) Stream.concat(ActorSql.baseProjectionMap.values.stream(), ActorSql.avatarProjectionMap.values.stream()) else ActorSql.baseProjectionMap.values.stream())
                .collect(Collectors.joining(", "))
    }

    fun allTables(): String {
        return ActorSql.tables(true, false, true)
    }
    ...
    fun tables(isFullProjection: Boolean, userOnly: Boolean, userIsOptional: Boolean): String {
        ...
        return if (isFullProjection || !userOnly && MyPreferences.getShowAvatars()) ActorSql.addAvatarImageTable(tables) else tables
    }
    ...
    private fun addAvatarImageTable(tables: String?): String {
        return ("(" + tables + ") LEFT OUTER JOIN (SELECT "
                ...
                + " FROM " + DownloadTable.TABLE_NAME + ") AS " + ActorSql.AVATAR_IMAGE_TABLE_ALIAS
                + " ON "
                + ActorSql.AVATAR_IMAGE_TABLE_ALIAS + "." + DownloadTable.ACTOR_ID
                + "=" + ActorTable.TABLE_NAME + "." + BaseColumns._ID
                + " AND "
                + ActorSql.AVATAR_IMAGE_TABLE_ALIAS + "." + DownloadTable.DOWNLOAD_NUMBER + "=0")
    }

    init {
        ActorSql.fullProjectionMap[BaseColumns._ID] = ActorTable.TABLE_NAME + "." + BaseColumns._ID + " AS " + BaseColumns._ID
        ActorSql.userOnlyProjectionMap[ActorTable.ACTOR_ID] = (ActorTable.TABLE_NAME + "." + BaseColumns._ID
                + " AS " + ActorTable.ACTOR_ID)
        ActorSql.baseProjectionMap[ActorTable.ORIGIN_ID] = ActorTable.TABLE_NAME + "." + ActorTable.ORIGIN_ID
        ActorSql.baseProjectionMap[ActorTable.ACTOR_OID] = ActorTable.TABLE_NAME + "." + ActorTable.ACTOR_OID
        ActorSql.baseProjectionMap[ActorTable.GROUP_TYPE] = ActorTable.TABLE_NAME + "." + ActorTable.GROUP_TYPE
        ActorSql.fullProjectionMap[ActorTable.PARENT_ACTOR_ID] = ActorTable.TABLE_NAME + "." + ActorTable.PARENT_ACTOR_ID
        ActorSql.baseProjectionMap[ActorTable.REAL_NAME] = ActorTable.TABLE_NAME + "." + ActorTable.REAL_NAME
        ActorSql.baseProjectionMap[ActorTable.USERNAME] = ActorTable.TABLE_NAME + "." + ActorTable.USERNAME
        ActorSql.baseProjectionMap[ActorTable.WEBFINGER_ID] = ActorTable.TABLE_NAME + "." + ActorTable.WEBFINGER_ID
        ActorSql.baseProjectionMap[ActorTable.SUMMARY] = ActorTable.TABLE_NAME + "." + ActorTable.SUMMARY
        ActorSql.baseProjectionMap[ActorTable.LOCATION] = ActorTable.TABLE_NAME + "." + ActorTable.LOCATION
        ActorSql.baseProjectionMap[ActorTable.PROFILE_PAGE] = ActorTable.TABLE_NAME + "." + ActorTable.PROFILE_PAGE
        ActorSql.baseProjectionMap[ActorTable.HOMEPAGE] = ActorTable.TABLE_NAME + "." + ActorTable.HOMEPAGE
        ActorSql.avatarProjectionMap[ActorTable.AVATAR_URL] = ActorTable.TABLE_NAME + "." + ActorTable.AVATAR_URL
        ActorSql.baseProjectionMap[ActorTable.NOTES_COUNT] = ActorTable.TABLE_NAME + "." + ActorTable.NOTES_COUNT
        ActorSql.baseProjectionMap[ActorTable.FAVORITES_COUNT] = ActorTable.TABLE_NAME + "." + ActorTable.FAVORITES_COUNT
        ActorSql.baseProjectionMap[ActorTable.FOLLOWING_COUNT] = ActorTable.TABLE_NAME + "." + ActorTable.FOLLOWING_COUNT
        ActorSql.baseProjectionMap[ActorTable.FOLLOWERS_COUNT] = ActorTable.TABLE_NAME + "." + ActorTable.FOLLOWERS_COUNT
        ActorSql.fullProjectionMap[ActorTable.ACTOR_ACTIVITY_ID] = ActorTable.TABLE_NAME + "." + ActorTable.ACTOR_ACTIVITY_ID
        ActorSql.fullProjectionMap[ActorTable.ACTOR_ACTIVITY_DATE] = ActorTable.TABLE_NAME + "." + ActorTable.ACTOR_ACTIVITY_DATE
        ActorSql.baseProjectionMap[ActorTable.CREATED_DATE] = ActorTable.TABLE_NAME + "." + ActorTable.CREATED_DATE
        ActorSql.baseProjectionMap[ActorTable.UPDATED_DATE] = ActorTable.TABLE_NAME + "." + ActorTable.UPDATED_DATE
        ActorSql.fullProjectionMap[ActorTable.INS_DATE] = ActorTable.TABLE_NAME + "." + ActorTable.INS_DATE
        ActorSql.avatarProjectionMap[DownloadTable.AVATAR_FILE_NAME] = (ActorSql.AVATAR_IMAGE_TABLE_ALIAS + "." + DownloadTable.FILE_NAME
                + " AS " + DownloadTable.AVATAR_FILE_NAME)
        ActorSql.avatarProjectionMap[DownloadTable.WIDTH] = DownloadTable.WIDTH
        ActorSql.avatarProjectionMap[DownloadTable.HEIGHT] = DownloadTable.HEIGHT
        ActorSql.avatarProjectionMap[DownloadTable.DOWNLOAD_STATUS] = DownloadTable.DOWNLOAD_STATUS
        ActorSql.avatarProjectionMap[DownloadTable.DOWNLOADED_DATE] = DownloadTable.DOWNLOADED_DATE
        ActorSql.userOnlyProjectionMap[ActorTable.USER_ID] = ActorTable.TABLE_NAME + "." + ActorTable.USER_ID
        ActorSql.userOnlyProjectionMap[UserTable.IS_MY] = UserTable.TABLE_NAME + "." + UserTable.IS_MY
        ActorSql.userOnlyProjectionMap[UserTable.KNOWN_AS] = UserTable.TABLE_NAME + "." + UserTable.KNOWN_AS
        ActorSql.baseProjectionMap.putAll(ActorSql.userOnlyProjectionMap)
        ActorSql.fullProjectionMap.putAll(ActorSql.baseProjectionMap)
        ActorSql.fullProjectionMap.putAll(ActorSql.avatarProjectionMap)
    }
}
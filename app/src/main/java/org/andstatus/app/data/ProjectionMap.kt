...
object ProjectionMap {
    ...
    init {
        ProjectionMap.TIMELINE[ActivityTable.ACTIVITY_ID] = (ProjectionMap.ACTIVITY_TABLE_ALIAS + "." + BaseColumns._ID
                + " AS " + ActivityTable.ACTIVITY_ID)
        ProjectionMap.TIMELINE[ActivityTable.ORIGIN_ID] = ActivityTable.ORIGIN_ID
        ProjectionMap.TIMELINE[ActivityTable.ACCOUNT_ID] = ActivityTable.ACCOUNT_ID
        ProjectionMap.TIMELINE[ActivityTable.ACTIVITY_TYPE] = ActivityTable.ACTIVITY_TYPE
        ProjectionMap.TIMELINE[ActivityTable.ACTOR_ID] = ActivityTable.ACTOR_ID
        ProjectionMap.TIMELINE[ActivityTable.AUTHOR_ID] = ActivityTable.AUTHOR_ID
        ProjectionMap.TIMELINE[ActivityTable.NOTE_ID] = ActivityTable.NOTE_ID
        ProjectionMap.TIMELINE[ActivityTable.OBJ_ACTOR_ID] = ActivityTable.OBJ_ACTOR_ID
        ProjectionMap.TIMELINE[ActivityTable.SUBSCRIBED] = ActivityTable.SUBSCRIBED
        ProjectionMap.TIMELINE[ActivityTable.NOTIFIED] = ActivityTable.NOTIFIED
        ProjectionMap.TIMELINE[ActivityTable.INS_DATE] = ActivityTable.INS_DATE
        ProjectionMap.TIMELINE[ActivityTable.UPDATED_DATE] = ActivityTable.UPDATED_DATE
        ProjectionMap.TIMELINE[BaseColumns._ID] = ProjectionMap.NOTE_TABLE_ALIAS + "." + BaseColumns._ID + " AS " + BaseColumns._ID
        ProjectionMap.TIMELINE[NoteTable.NOTE_ID] = ProjectionMap.NOTE_TABLE_ALIAS + "." + BaseColumns._ID + " AS " + NoteTable.NOTE_ID
        ProjectionMap.TIMELINE[NoteTable.ORIGIN_ID] = NoteTable.ORIGIN_ID
        ProjectionMap.TIMELINE[NoteTable.NOTE_OID] = NoteTable.NOTE_OID
        ProjectionMap.TIMELINE[NoteTable.CONVERSATION_ID] = NoteTable.CONVERSATION_ID
        ProjectionMap.TIMELINE[NoteTable.AUTHOR_ID] = NoteTable.AUTHOR_ID
        ProjectionMap.TIMELINE[ActorTable.AUTHOR_NAME] = ActorTable.AUTHOR_NAME
        ProjectionMap.TIMELINE[DownloadTable.DOWNLOAD_STATUS] = DownloadTable.DOWNLOAD_STATUS
        ProjectionMap.TIMELINE[DownloadTable.FILE_NAME] = DownloadTable.FILE_NAME
        ProjectionMap.TIMELINE[DownloadTable.IMAGE_FILE_NAME] = (ProjectionMap.ATTACHMENT_IMAGE_TABLE_ALIAS + "." + DownloadTable.FILE_NAME
                + " AS " + DownloadTable.IMAGE_FILE_NAME)
        ProjectionMap.TIMELINE[DownloadTable.IMAGE_ID] = (ProjectionMap.ATTACHMENT_IMAGE_TABLE_ALIAS + "." + BaseColumns._ID
                + " AS " + DownloadTable.IMAGE_ID)
        ProjectionMap.TIMELINE[DownloadTable.IMAGE_URI] = (ProjectionMap.ATTACHMENT_IMAGE_TABLE_ALIAS + "." + DownloadTable.URL
                + " AS " + DownloadTable.IMAGE_URI)
        ProjectionMap.TIMELINE[DownloadTable.PREVIEW_OF_DOWNLOAD_ID] = DownloadTable.PREVIEW_OF_DOWNLOAD_ID
        ProjectionMap.TIMELINE[DownloadTable.WIDTH] = DownloadTable.WIDTH
        ProjectionMap.TIMELINE[DownloadTable.HEIGHT] = DownloadTable.HEIGHT
        ProjectionMap.TIMELINE[DownloadTable.DURATION] = DownloadTable.DURATION
        ProjectionMap.TIMELINE[NoteTable.NAME] = NoteTable.NAME
        ProjectionMap.TIMELINE[NoteTable.SUMMARY] = NoteTable.SUMMARY
        ProjectionMap.TIMELINE[NoteTable.SENSITIVE] = NoteTable.SENSITIVE
        ProjectionMap.TIMELINE[NoteTable.CONTENT] = NoteTable.CONTENT
        ProjectionMap.TIMELINE[NoteTable.CONTENT_TO_SEARCH] = NoteTable.CONTENT_TO_SEARCH
        ProjectionMap.TIMELINE[NoteTable.VIA] = NoteTable.VIA
        ProjectionMap.TIMELINE[NoteTable.URL] = NoteTable.URL
        ProjectionMap.TIMELINE[NoteTable.IN_REPLY_TO_NOTE_ID] = NoteTable.IN_REPLY_TO_NOTE_ID
        ProjectionMap.TIMELINE[NoteTable.IN_REPLY_TO_ACTOR_ID] = NoteTable.IN_REPLY_TO_ACTOR_ID
        ProjectionMap.TIMELINE[NoteTable.VISIBILITY] = NoteTable.VISIBILITY
        ProjectionMap.TIMELINE[NoteTable.FAVORITED] = NoteTable.FAVORITED
        ProjectionMap.TIMELINE[NoteTable.REBLOGGED] = NoteTable.REBLOGGED
        ProjectionMap.TIMELINE[NoteTable.LIKES_COUNT] = NoteTable.LIKES_COUNT
        ProjectionMap.TIMELINE[NoteTable.REBLOGS_COUNT] = NoteTable.REBLOGS_COUNT
        ProjectionMap.TIMELINE[NoteTable.REPLIES_COUNT] = NoteTable.REPLIES_COUNT
        ProjectionMap.TIMELINE[NoteTable.UPDATED_DATE] = NoteTable.UPDATED_DATE
        ProjectionMap.TIMELINE[NoteTable.NOTE_STATUS] = NoteTable.NOTE_STATUS
        ProjectionMap.TIMELINE[NoteTable.INS_DATE] = NoteTable.INS_DATE
        ProjectionMap.TIMELINE[NoteTable.ATTACHMENTS_COUNT] = NoteTable.ATTACHMENTS_COUNT
    }
}
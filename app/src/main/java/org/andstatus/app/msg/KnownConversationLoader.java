 ...
 */
public class KnownConversationLoader<T extends ConversationItem> extends ConversationLoader<T> {
    public KnownConversationLoader(Class<T> tClass, MyContext myContext, MyAccount ma,

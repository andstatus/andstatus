...
enum class ActorEndpointType(val id: Long) {
    EMPTY(0), API_PROFILE(1), API_INBOX(2), API_OUTBOX(3), API_FOLLOWING(4), API_FOLLOWERS(5), API_LIKED(6), BANNER(7), API_SHARED_INBOX(8), API_UPLOAD_MEDIA(9);

    companion object {
        fun fromId(id: Long): ActorEndpointType? {
            for (`val` in ActorEndpointType.values()) {
                if (`val`.id == id) {
                    return `val`
                }
            }
            return ActorEndpointType.EMPTY
        }

        fun from(routine: ApiRoutineEnum?): ActorEndpointType? {
            return when (routine) {
                ApiRoutineEnum.GET_FOLLOWERS, ApiRoutineEnum.GET_FOLLOWERS_IDS -> ActorEndpointType.API_FOLLOWERS
                ApiRoutineEnum.GET_FRIENDS, ApiRoutineEnum.GET_FRIENDS_IDS -> ActorEndpointType.API_FOLLOWING
                ApiRoutineEnum.GET_ACTOR -> ActorEndpointType.API_PROFILE
                ApiRoutineEnum.HOME_TIMELINE -> ActorEndpointType.API_INBOX
                ApiRoutineEnum.LIKED_TIMELINE -> ActorEndpointType.API_LIKED
                ApiRoutineEnum.LIKE, ApiRoutineEnum.UNDO_LIKE, ApiRoutineEnum.FOLLOW, ApiRoutineEnum.UPDATE_PRIVATE_NOTE, ApiRoutineEnum.ANNOUNCE, ApiRoutineEnum.DELETE_NOTE, ApiRoutineEnum.UPDATE_NOTE, ApiRoutineEnum.ACTOR_TIMELINE -> ActorEndpointType.API_OUTBOX
                ApiRoutineEnum.PUBLIC_TIMELINE -> ActorEndpointType.API_SHARED_INBOX
                ApiRoutineEnum.UPLOAD_MEDIA -> ActorEndpointType.API_UPLOAD_MEDIA
                else -> ActorEndpointType.EMPTY
            }
        }

        fun from(groupType: GroupType?): ActorEndpointType? {
            return when (groupType) {
                GroupType.FOLLOWERS -> ActorEndpointType.API_FOLLOWERS
                GroupType.FRIENDS -> ActorEndpointType.API_FOLLOWING
                else -> ActorEndpointType.EMPTY
            }
        }
    }

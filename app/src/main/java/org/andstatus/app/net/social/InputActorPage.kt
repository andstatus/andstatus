...
class InputActorPage(jsonCollection: AJsonCollection?, actors: MutableList<Actor?>?) : InputPage<Actor?>(jsonCollection, actors) {
    ...
    companion object {
        val EMPTY: InputActorPage? = InputActorPage.Companion.of(emptyList())
        val TRY_EMPTY = Try.success<InputActorPage?>(InputActorPage.Companion.EMPTY)
        fun of(actors: MutableList<Actor?>?): InputActorPage? {
            return InputActorPage(AJsonCollection.Companion.EMPTY, actors)
        }

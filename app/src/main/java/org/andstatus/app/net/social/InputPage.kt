...
abstract class InputPage<T> protected constructor(jsonCollection: AJsonCollection?, items: MutableList<T?>?) : HasEmpty<T?> {
    val firstPosition: TimelinePosition?
    val youngerPosition: TimelinePosition?
    val thisPosition: TimelinePosition?
    ...
    init {
        firstPosition = TimelinePosition.Companion.of(jsonCollection.firstPage.getId())
        youngerPosition = TimelinePosition.Companion.of(jsonCollection.prevPage.getId())

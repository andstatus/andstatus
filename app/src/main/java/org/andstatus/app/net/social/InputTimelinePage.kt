...
class InputTimelinePage(jsonCollection: AJsonCollection?, activities: MutableList<AActivity?>?) : InputPage<AActivity?>(jsonCollection, activities) {
    ...
    companion object {
        val EMPTY: InputTimelinePage? = InputTimelinePage.Companion.of(emptyList())
        val TRY_EMPTY = Try.success<InputTimelinePage?>(InputTimelinePage.Companion.EMPTY)
        fun of(activities: MutableList<AActivity?>?): InputTimelinePage? {
            return InputTimelinePage(AJsonCollection.Companion.EMPTY, activities)
        }

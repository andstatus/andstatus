...
enum class SslModeEnum(val id: Long, private val summaryResourceId: Int) {
    SECURE(1, R.string.preference_ssl_mode_secure_summary), INSECURE(2, R.string.preference_ssl_mode_insecure_summary), MISCONFIGURED(3, R.string.preference_ssl_mode_misconfigured_summary);
    ...
    companion object {
        ...
        fun fromEntriesPosition(position: Int): SslModeEnum? {
            var obj: SslModeEnum? = SslModeEnum.SECURE
            for (`val` in SslModeEnum.values()) {

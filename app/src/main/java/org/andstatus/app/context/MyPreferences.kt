...
object MyPreferences {
    ...
    fun getConnectionTimeoutMs(): Int {
        return TimeUnit.SECONDS.toMillis(
                SharedPreferencesUtil.getLongStoredAsString(
                        KEY_CONNECTION_TIMEOUT_SECONDS, CONNECTION_TIMEOUT_DEFAULT_SECONDS)) as Int
    }
    ...
    fun getTapOnATimelineTitleBehaviour(): TapOnATimelineTitleBehaviour? {
        return TapOnATimelineTitleBehaviour.Companion.load(
                SharedPreferencesUtil.getString(KEY_TAP_ON_A_TIMELINE_TITLE_BEHAVIOUR, ""))
    }

    fun getActorInTimeline(): ActorInTimeline? {
        return ActorInTimeline.Companion.load(SharedPreferencesUtil.getString(KEY_ACTOR_IN_TIMELINE, ""))
    }
    ...
    fun isLogEverythingToFile(): Boolean {
        return SharedPreferencesUtil.getBoolean(KEY_LOG_EVERYTHING_TO_FILE, MyContextHolder.Companion.myContextHolder.getNow().isTestRun())
    }

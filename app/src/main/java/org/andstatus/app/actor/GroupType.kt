 ...
 */
enum class GroupType(val name: String?, val id: Long, isGroupLike: IsGroupLike?, isCollection: IsCollection?, isActorOwned: IsActorOwned?, precision: Long) {
    NOT_A_GROUP("NotAGroup", 1, IsGroupLike.NO, IsCollection.NO, IsActorOwned.NO, 1), PUBLIC("Public", 2, IsGroupLike.YES, IsCollection.NO, IsActorOwned.NO, 3), GENERIC("Generic", 6, IsGroupLike.YES, IsCollection.NO, IsActorOwned.NO, 1), COLLECTION("Collection", 7, IsGroupLike.YES, IsCollection.YES, IsActorOwned.NO, 1), FRIENDS("Friends", 3, IsGroupLike.YES, IsCollection.YES, IsActorOwned.YES, 3), FOLLOWERS("Followers", 4, IsGroupLike.YES, IsCollection.YES, IsActorOwned.YES, 3), ACTOR_OWNED("ActorOwned", 5, IsGroupLike.YES, IsCollection.NO, IsActorOwned.YES, 2), UNKNOWN("Unknown", 0, IsGroupLike.NO, IsCollection.NO, IsActorOwned.NO, 0);

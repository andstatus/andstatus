...
class MyBackupAgent : BackupAgent() {
    ...
    override fun onRestore(data: BackupDataInput?, appVersionCode: Int, newState: ParcelFileDescriptor?) {
        onRestore(
            MyBackupDataInput(getContext(), data), appVersionCode,
    ...
    private suspend fun restoreSharedPreferences(data: MyBackupDataInput) {
        ...
        SharedPreferencesUtil.copyAll(
            SharedPreferencesUtil.getSharedPreferences(filename),

...
internal class Convert47 : ConvertOneStep() {
    ...
    companion object {
        private val TAG: String = Convert47::class.simpleName!!
        fun convertJson16(myContext: MyContext, jsonIn: JSONObject, isPersistent: Boolean): Try<JSONObject> {
            ...
            try {
                ...
                jso.put(MyAccount.KEY_ACCOUNT_NAME, accountName)
                jso.put(MyAccount.KEY_USERNAME, newUserName)
                jso.put(MyAccount.KEY_UNIQUE_NAME, newUniqueName)

...
class DemoConversationInserter {
    ...
    private fun insertAndTestConversation() {
        ...
        reply1.getNote().replies.toMutableList().add(reply12)
        ...
        DemoNoteInserter.assertStoredVisibility(reply4, Visibility.PUBLIC_AND_TO_FOLLOWERS)
        assertIfActorIsMyFriend(author3, true, ma)
        val MENTIONS_NOTE_BODY = "@fourthWithoutAvatar@pump.example.com Reply 5 to Reply 4 @${author3.getUsername()} @unknownUser@example.com"
        ...
        addActivity(reply7)
        DemoNoteInserter.assertStoredVisibility(reply7, Visibility.PUBLIC_AND_TO_FOLLOWERS)
        ...
        val myLikeOf9: AActivity = AActivity.from(accountActor, ActivityType.LIKE)
        ...
        val reply11 = buildActivity(author2, "", "Reply 11 to Reply 7, " + DemoData.demoData.globalPublicNoteText
                ...
                .withVisibility(Visibility.PUBLIC_AND_TO_FOLLOWERS)
        addActivity(reply11)
        DemoNoteInserter.assertStoredVisibility(reply11, Visibility.PUBLIC_AND_TO_FOLLOWERS)
        ...
        val reply14 = buildActivity(author3, "", "Publicly reply to my note 13", myReply13, null)
                .withVisibility(Visibility.PUBLIC_AND_TO_FOLLOWERS)
        addActivity(reply14)
        DemoNoteInserter.assertStoredVisibility(reply14, Visibility.PUBLIC_AND_TO_FOLLOWERS)
        ...
        val notLoadedActor: Actor = Actor.fromOid(accountActor.origin, "acct:notloaded@someother.host."
        ...
        DemoNoteInserter.assertStoredVisibility(myReply17, Visibility.PUBLIC_AND_TO_FOLLOWERS)
    }

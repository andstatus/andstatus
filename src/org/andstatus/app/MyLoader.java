...
public class MyLoader<D> {
    ...
    public interface OnLoadCompleteListener<D> {
         ...
         */
        public void onLoadComplete(MyLoader<D> loader, D data);
    }
    ...
    public interface OnLoadCanceledListener<D> {
         ...
         */
        public void onLoadCanceled(MyLoader<D> loader);
    }
    ...
    public String dataToString(D data) {
        return MyLog.formatKeyValue(data, data);
    }
